module.exports = function getQuote() {
  const quotes = [
    ...
    "We should be sensible, tactful, considerate and humble without being servile or scraping. As Gods people we stand on our feet; we dont crawl before anyone.",
    ...
    'Ive been benefited from a dictionary definition I found that reads: "Rationalization is giving a socially acceptable reason for socially unacceptable behavior, and socially unacceptable behavior is a form of insanity.',
